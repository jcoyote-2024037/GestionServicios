...
const styles = StyleSheet.create({
  container: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 16 },
  navBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8 },
  disabled: { opacity: 0.3 },
  navText: { color: colors.textSecondary, fontSize: typography.sizes.sm },
  disabledText: { color: colors.textMuted },
  pageBtn: { width: 32, height: 32, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  pageText: { color: colors.textSecondary, fontSize: typography.sizes.sm },
  activePage: { backgroundColor: `${colors.brand}30`, borderWidth: 1, borderColor: `${colors.brand}50` },
  activeText: { color: colors.brand },
  ellipsis: { color: colors.textMuted, fontSize: typography.sizes.sm },
})
