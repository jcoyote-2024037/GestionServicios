    ...
    >
      ...
      {service.featured && (
        <div className="absolute top-2 right-2 z-10">
          <span className="px-2 py-0.5 rounded-full text-[10px] font-bold tracking-wider text-white uppercase"
            style={{
      ...
      <div className="relative w-full h-40 rounded-xl mb-3 overflow-hidden">
        {service.imagenes?.[0] ? (
          <>
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[rgba(9,9,11,0.6)] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </>
        ) : (
